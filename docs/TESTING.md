...
0.0.1.30: Check all supplied labels, explicit title date/rights/distributor precedence, conflicting studios and Legendary UNKNOWN, Sony Pay-2 eligibility and Universal sequential windows. Verify date ranges across month/year boundaries, no US theatrical date, old catalog, and rent/buy-only responses. Batch results expose escaped windows/research links; recovery, concurrent-edit guards, cancellation and partial saves remain. Estimates change How only, never Available Date.
